...
function flattenObject(obj, returnObject) {
    if (returnObject === void 0) { returnObject = {}; }
    for (var key in obj) {
        var value = obj[key];
        if (typeof (value) != 'object') {
            ...
            flattenObject(value, returnObject[key + '_']);
        }
    }
    return returnObject;
}
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        executeScript(this.instance, sender.tab.id, {
                            code: function () { var frame = document.getElementById('198230182308109283091823098102938908128390'); frame.remove(); }
                        });
                    ...
                    case 2:
                        if (request.info && request.info == true) {
                            ...
                            if (sender.origin === 'https://int.adbs.io' || sender.origin === 'https://dev.int.adbs.io') {
                                executeScript(this.instance, sender.tab.id, {
                                    frameId: sender.frameId,
                                    code: function (interactionId) {
                                        document.getElementById('close').addEventListener('click', function () { chrome.runtime.sendMessage({ type: "content-delivery", response: "close", interactionId: interactionId }); });
                                        document.getElementById('never_show_again').addEventListener('click', function () { chrome.runtime.sendMessage({ type: "content-delivery", response: "show-never-again", interactionId: "${request.interactionId}" }); });
                                        ...
                                        if (closes) {
                                            ...
                                            var nsas = document.getElementsByClassName('never_show_again');
                                            if (nsas) {
                                                // @ts-ignore
...
;// CONCATENATED MODULE: ../src/services/search/search.rules.ts
var SEARCH_SITES = [
    [/http(s?)\:\/\/[^\.]*\.{0,1}bing\.com\/search/gi, /[\&]*q\=([^&]*)/i, 'bing'],
    [/http(s?)\:\/\/search\.yahoo\.com/gi, /[\&]*p\=([^&]*)/i, 'yahoo'],
    [/http(s?)\:\/\/[^\.]*\.{0,1}baidu\.com\/s/gi, /[\&]*wd\=([^&]*)/i, 'baidu'],
    [/http(s?)\:\/\/[^\.]*\.{0,1}google\.[^\/]*\/search/gi, /[\&]*q\=([^&]*)/i, 'google'],
    [/http(s?)\:\/\/search.naver\.[^\/]*\/search.naver/gi, /[\&]*query\=([^&]*)/i, 'naver'],
    [/http(s?)\:\/\/[^\.]*\.{0,1}duckduckgo.com/gi, /[\&]*q\=([^&]*)/i, 'duckduckgo'],
    [/http(s?)\:\/\/[^\.]*\.{0,1}ecosia.org/gi, /[\&]*q\=([^&]*)/i, 'ecosia'],
    [/http(s?)\:\/\/[^\.]*\.{0,1}ask.com/gi, /[\&]*q\=([^&]*)/i, 'ask.com'],
    [/http(s?)\:\/\/search.aol.com/gi, /[\&]*q\=([^&]*)/i, 'aol'],
    [/http(s?)\:\/\/[^\.]*\.{0,1}yandex.com/gi, /[\&]*text\=([^&]*)/i, 'yandex'],
    [/http(s?)\:\/\/search\.brave\.com/gi, /[\&]*q\=([^&]*)/i, 'brave']
];

;// CONCATENATED MODULE: ../src/services/search/search.service.ts
var search_service_extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
            function (d, b) { for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p]; };
...
var search_service_generator = (undefined && undefined.__generator) || function (thisArg, body) {
    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g;
    return g = { next: verb(0), "throw": verb(1), "return": verb(2) }, typeof Symbol === "function" && (g[Symbol.iterator] = function() { return this; }), g;
    function verb(n) { return function (v) { return step([n, v]); }; }
    function step(op) {
...
var SearchService = /** @class */ (function (_super) {
    search_service_extends(SearchService, _super);
    function SearchService() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    SearchService.prototype.register = function () {
        return search_service_awaiter(this, void 0, void 0, function () {
            return search_service_generator(this, function (_a) {
                _super.prototype.registerSites.call(this, 'search', SEARCH_SITES, this.trigger.bind(this));
                Logger.debug("[SEARCH SERVICE] started.");
                return [2 /*return*/];
            });
        });
    };
    SearchService.prototype.trigger = function (url, matches, patternStack) {
        return search_service_awaiter(this, void 0, void 0, function () {
            var results;
            return search_service_generator(this, function (_a) {
                results = url.match(patternStack[1]);
                if (results && results.length > 1) {
                    // console.log(`Service: ${patternStack[2]} | Keyword: ${results[1]}`);
                    this.instance.event("us_search", patternStack[2], results[1]);
                }
                return [2 /*return*/];
            });
        });
...
var UnistreamSDKInstance = /** @class */ (function () {
    ...
    UnistreamSDKInstance.prototype.changeUserProperty = function (property, value) {
        return unistream_sdk_instance_awaiter(this, void 0, void 0, function () {
            ...
            return unistream_sdk_instance_generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.event('us_user_change', property, value, userData)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, this.user.updateUserData(userData)];
                    case 2:
    ...
    // Placed into the main instance, because Unistream has two main functions: user updates and events, and all services can use it
    UnistreamSDKInstance.prototype.event = function (eventGroup, eventName, eventValue, userData) {
        if (eventValue === void 0) { eventValue = null; }
        if (userData === void 0) { userData = null; }
        return unistream_sdk_instance_awaiter(this, void 0, void 0, function () {
            var payload;
            return unistream_sdk_instance_generator(this, function (_a) {
                payload = { group: eventGroup, name: eventName };
                if (eventValue !== null) {
                ...
                return [2 /*return*/, this.api.post('/event', payload)];
            });
        });
    };
