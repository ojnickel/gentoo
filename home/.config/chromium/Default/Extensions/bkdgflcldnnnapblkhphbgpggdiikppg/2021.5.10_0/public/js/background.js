...
},{"../shared-utils/parse-user-agent-string.es6":50,"./chrome-wrapper.es6":23,"./load.es6":36,"./settings.es6":42}],21:[function(require,module,exports){
"use strict";
...
},{"./chrome-events.es6":22,"./settings.es6":42}],22:[function(require,module,exports){
"use strict";
...
var IS_BETA = RELEASE_EXTENSION_IDS.indexOf(chrome.runtime.id) === -1; // eslint-disable-line no-unused-vars
...
var cookieConfig = require('./../background/storage/cookies.es6');
...
var isFlocEnabled = ('interestCohort' in document); // Overwrite FLoC JS API
...
chrome.runtime.onMessage.addListener(function (req, sender, res) {
  ...
  if (req.registeredContentScript || req.registeredTempAutofillContentScript) {
    ...
    if (argumentsObject.site.isBroken) {
      console.log('temporarily skip protections for site: ' + sender.tab.url + 'more info: https://github.com/duckduckgo/content-blocking-whitelist');
      return;
    }
...
function getArgumentsObject(tabId, sender, documentUrl) {
  ...
  var site = (tab === null || tab === void 0 ? void 0 : tab.site) || {};
...
chrome.webNavigation.onCommitted.addListener(function (details) {
  ...
  if (tab && tab.site.isBroken) {
    console.log('temporarily skip embedded object replacements for site: ' + details.url + 'more info: https://github.com/duckduckgo/content-blocking-lists');
    return;
  }
...
chrome.alarms.create('updateUserAgentData', {
  periodInMinutes: 30
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            cookieConfig.updateCookieData(); // fetch alias if needed
...
},{"../../data/constants":14,"../shared-utils/sha1":51,"./../background/storage/cookies.es6":43,"./GPC.es6":18,"./atb.es6":20,"./chrome-wrapper.es6":23,"./companies.es6":30,"./csp-blocking.es6":31,"./email-utils.es6":32,"./experiments.es6":33,"./https-service.es6":34,"./https.es6":35,"./onboarding.es6":38,"./pixel.es6":39,"./redirect.es6":41,"./settings.es6":42,"./storage/https.es6":44,"./storage/tds.es6":45,"./tab-manager.es6":46,"./tracker-utils":47,"./trackers.es6":48,"./utils.es6":49,"regenerator-runtime/runtime":11,"tldts":13}],23:[function(require,module,exports){
"use strict";
...
},{"../../../data/constants":14,"../pixel.es6":39,"../utils.es6":49}],26:[function(require,module,exports){
"use strict";
...
},{"../chrome-wrapper.es6":23,"../privacy-practices.es6":40,"../settings.es6":42,"../utils.es6":49,"./../storage/tds.es6":45,"@duckduckgo/privacy-grade":2}],27:[function(require,module,exports){
"use strict";
...
},{"../companies.es6":30,"../storage/tds.es6":45}],30:[function(require,module,exports){
"use strict";
...
},{"./chrome-wrapper.es6":23,"./classes/company.es6":24,"./classes/top-blocked.es6":28,"./migrate.es6":37}],31:[function(require,module,exports){
"use strict";
...
},{"./settings.es6":42}],33:[function(require,module,exports){
"use strict";
...
},{"../../data/constants":14,"../shared-utils/sha1":51,"punycode":7}],35:[function(require,module,exports){
(function (Buffer){(function (){
"use strict";
...
},{"./chrome-wrapper.es6":23,"./https-service.es6":34,"./pixel.es6":39,"./settings.es6":42,"./tab-manager.es6":46,"./utils.es6":49,"@duckduckgo/jsbloom":1,"buffer":6,"tldts":13}],36:[function(require,module,exports){
"use strict";
...
},{"./chrome-wrapper.es6":23}],37:[function(require,module,exports){
"use strict";
...
},{"../shared-utils/parse-user-agent-string.es6":50,"./chrome-wrapper.es6":23,"./load.es6":36,"./settings.es6":42}],40:[function(require,module,exports){
"use strict";
  ...
  if (requestData.type === 'main_frame' && window.chrome) {
    ...
    if (tracker && !(tracker.action === 'ignore' && tracker.reason !== 'first party')) {
      ...
      if (!thisTab.site.whitelisted && tracker.action.match(/block|redirect/)) {
        if (sameDomain) thisTab.addOrUpdateTrackersBlocked(tracker); // update badge icon for any requests that come in after
...
},{"./atb.es6":20,"./chrome-wrapper.es6":23,"./companies.es6":30,"./https.es6":35,"./settings.es6":42,"./tab-manager.es6":46,"./tracker-utils":47,"./trackers.es6":48,"./utils.es6":49,"tldts":13}],42:[function(require,module,exports){
"use strict";
...
},{"../../data/defaultSettings":15,"./chrome-wrapper.es6":23}],43:[function(require,module,exports){
"use strict";
...
var ExcludedCookieStorage = /*#__PURE__*/function () {
  function ExcludedCookieStorage() {
    _classCallCheck(this, ExcludedCookieStorage);
  ...
  _createClass(ExcludedCookieStorage, [{
    key: "updateCookieData",
    value: function updateCookieData() {
      var _this = this;

      console.log('Cookies: Getting cookie data');
      var lists = constants.CookieLists;
      ...
      try {
        var _loop = function _loop() {
          ...
          var source = list.source || 'external';
          var listName = list.name;
          var etag = settings.getSetting("".concat(listName, "-etag")) || '';
          load.loadExtensionFile({
            ...
            if (response && response.status === 200) {
              ...
              _this.storeExclusionList(listName, data);

              _this.processList(listName, data);

              var newEtag = response.getResponseHeader('etag') || '';
              settings.updateSetting("".concat(listName, "-etag"), newEtag);
            } else if (response && response.status === 304) {
              _this.loadExclusionList(listName, function (results) {
                if (chrome.runtime.lastError || !results[listName]) {
                  console.log("Error loading Exclusion settings from storage: ".concat(chrome.runtime.lastError));
                  settings.updateSetting("".concat(listName, "-etag"), '');
                }

                _this.processList(listName, results[listName]);
              });
            }
          })["catch"](function (e) {
            // Reset the etag
            settings.updateSetting("".concat(listName, "-etag"), '');
            console.log("Error updating cookie data:  ".concat(e, ". Attempting to load from local storage."));
    ...
    key: "processList",
    value: function processList(listName, listData) {
      switch (listName) {
    ...
    value: function () {
      var _processExcludeList = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data) {
        var _iterator2, _step2, record;
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                this.excludedDomains = [];
                _iterator2 = _createForOfIteratorHelper(data.excludedDomains);
      ...
      function processExcludeList(_x) {
        return _processExcludeList.apply(this, arguments);
      }

      return processExcludeList;
    }()
  }, {
    key: "loadExclusionList",
    value: function loadExclusionList(listName, callback) {
      console.log("looking for listname ".concat(listName));
      chrome.storage.local.get(listName, callback);
    }
  }, {
    key: "storeExclusionList",
    value: function storeExclusionList(listname, data) {
      chrome.storage.local.set(_defineProperty({}, listname, data), function () {});
    }
  }, {
    key: "isExcluded",
    value: function isExcluded(url) {
      var domain = new URL(url).host;
      return this.isDomainExcluded(domain);
    }
  }, {
    key: "isDomainExcluded",
    value: function isDomainExcluded(domain) {
      if (this.excludedDomains.find(function (elem) {
        return elem === domain;
      })) {
        return true;
      }
  ...
  return ExcludedCookieStorage;
}();

module.exports = new ExcludedCookieStorage();

},{"../../../data/constants":14,"./../load.es6":36,"./../settings.es6":42,"regenerator-runtime/runtime":11}],44:[function(require,module,exports){
(function (Buffer){(function (){
"use strict";
...
},{"../../../data/constants":14,"./../load.es6":36,"./../settings.es6":42,"buffer":6,"dexie":8}],45:[function(require,module,exports){
"use strict";
...
var TDSStorage = /*#__PURE__*/function () {
  ...
  _createClass(TDSStorage, [{
    ...
    value: function getDataFromLocalDB(name) {
      ...
      return this.dbc.open().then(function () {
        return _this2.dbc.table('tdsStorage').get({
          name: name
        });
      });
    }
...
},{"../../../data/constants":14,"./../chrome-wrapper.es6":23,"./../load.es6":36,"./../settings.es6":42,"dexie":8}],46:[function(require,module,exports){
"use strict";
...
},{"./chrome-wrapper.es6":23,"./classes/tab.es6":27,"./companies.es6":30,"./settings.es6":42}],47:[function(require,module,exports){
"use strict";
...
function facebookExperimentIsActive() {
  ...
  if (activeExperiment) {
    var experiment = settings.getSetting('experimentData');
...
function truncateReferrer(referrer, target) {
  ...
  if (tdsStorage.ReferrerExcludeList && tdsStorage.ReferrerExcludeList.excludedReferrers) {
    var excludedDomains = tdsStorage.ReferrerExcludeList.excludedReferrers.map(function (e) {
      return e.domain;
    });

    try {
      if (excludedDomains.includes(tldts.parse(referrer).domain) || excludedDomains.includes(tldts.parse(target).domain)) {
        // referrer or target is in the Referrer safe list
        return undefined;
      }
    } catch (e) {// if we can't parse the domains for any reason, assume it's not exluded.
    }
  }
...
},{"./settings.es6":42,"./storage/tds.es6":45,"./trackers.es6":48,"./utils.es6":49,"tldts":13}],48:[function(require,module,exports){
"use strict";
...
function isBroken(url) {
  if (!(tdsStorage !== null && tdsStorage !== void 0 && tdsStorage.brokenSiteList)) return;
  return isBrokenList(url, tdsStorage.brokenSiteList);
}

function getBrokenFeatures(url) {
  if (!(tdsStorage !== null && tdsStorage !== void 0 && tdsStorage.protections)) return;
  var brokenFeatures = [];

  for (var feature in tdsStorage.protections) {
    var _tdsStorage$protectio;

    if (!((_tdsStorage$protectio = tdsStorage.protections[feature]) !== null && _tdsStorage$protectio !== void 0 && _tdsStorage$protectio.enabled)) {
...
function isBrokenList(url, lists) {
  ...
  return lists.some(function (brokenSiteDomain) {
    if (brokenSiteDomain) {
...
function getBrokenScriptLists() {
  ...
  for (var key in tdsStorage === null || tdsStorage === void 0 ? void 0 : tdsStorage.protections) {
    var _tdsStorage$protectio2;

    brokenScripts[key] = ((_tdsStorage$protectio2 = tdsStorage.protections[key]) === null || _tdsStorage$protectio2 === void 0 ? void 0 : _tdsStorage$protectio2.scripts) || [];
  }
...
},{"../../data/constants":14,"../shared-utils/parse-user-agent-string.es6":50,"./load.es6":36,"./settings.es6":42,"./storage/tds.es6":45,"tldts":13}],50:[function(require,module,exports){
"use strict";
