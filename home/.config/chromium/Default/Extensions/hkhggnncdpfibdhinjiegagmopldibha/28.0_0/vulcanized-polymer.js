import { html as html$1, Polymer, IronResizableBehavior, dom, animationFrame, Debouncer, enqueueDebouncer, html$1 as html, afterNextRender, resolveUrl, IronButtonState, IronButtonStateImpl, IronControlState, PaperRippleBehavior, PaperInkyFocusBehavior } from './shared_bundle_1.js';
...
document.head.appendChild(template$1.content); /// BareSpecifier=@polymer\iron-icons\editor-icons

const template$2 = html`<iron-iconset-svg name="editor" size="24">
<svg><defs>
...
document.head.appendChild(template$2.content); /// BareSpecifier=@polymer\iron-icons\image-icons

const template$3 = html`<iron-iconset-svg name="image" size="24">
<svg><defs>
...
document.head.appendChild(template$3.content); /// BareSpecifier=@polymer\iron-icons\iron-icons
...
document.head.appendChild(template$4.content); /// BareSpecifier=@polymer\iron-icons\maps-icons
...
document.head.appendChild(template$5.content); /// BareSpecifier=@polymer\iron-icons\notification-icons

const template$6 = html`<iron-iconset-svg name="notification" size="24">
<svg><defs>
...
document.head.appendChild(template$6.content); /// BareSpecifier=@polymer\iron-icons\social-icons

const template$7 = html`<iron-iconset-svg name="social" size="24">
<svg><defs>
...
document.head.appendChild(template$7.content); /// BareSpecifier=@polymer\iron-image\iron-image
...
document.body.appendChild(template$b.content); /**
