# sysctl
# Autogenerated from man page /usr/share/man/man8/sysctl.8.bz2
...
complete -c sysctl -s V -l version -d 'Display version information and exit.  EXAMPLES /usr/sbin/sysctl -a'
