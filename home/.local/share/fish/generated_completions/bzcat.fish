# bzcat
# Autogenerated from man page /usr/share/man/man1/bzcat.1.bz2
...
complete -c bzcat -s p -l show-progress -d 'Show percentage of input-file done and while compressing show the percentage …'
