# bunzip2
# Autogenerated from man page /usr/share/man/man1/bunzip2.1.bz2
...
complete -c bunzip2 -s p -l show-progress -d 'Show percentage of input-file done and while compressing show the percentage …'
